...
class SnapshotMonitorsTest {
    ...
    void reset() {
        ...
        repositoryService.createProcessDefinitionQuery().list().forEach(
    ...
    void externalTaskErrorGauge() {
        ...
        externalTaskService.fetchAndLock(EXPECTED_COUNT, WORKER_ID).topic("test-topic", 10).execute()
